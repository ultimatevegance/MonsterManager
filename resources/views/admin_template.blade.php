...
<head>
  ...
  <title>MonsterManager System</title>
...
<div class="wrapper">
    ...
    <section class="content-header">
      <h1>
        Main Features
        <small>This is the feature management section</small>
      </h1>
      <ol class="breadcrumb">
	    ...
	    <div class="col-md-4">
          ...
          <div class="box box-widget widget-user">
            ...
            <div class="widget-user-image">
              <img class="img-circle" src="{{ asset("/bower_components/admin-lte/dist/img/MineAvatar.jpg") }}" alt="User Avatar">
            </div>
    ...
    <section class="content">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <div class="chart">
                <canvas id="areaChart" style="height: 250px; width: 475px;" height="250" width="475"></canvas>
              </div>
            </div>
            <!-- /.box-body -->
          </div>
        ...
        <div class="col-md-6">
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <div class="chart">
                <canvas id="lineChart" style="height: 250px; width: 475px;" height="250" width="475"></canvas>
              </div>
            </div>
            <!-- /.box-body -->
          </div>
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
              <div class="chart">
                <canvas id="barChart" style="height: 230px; width: 475px;" height="230" width="475"></canvas>
              </div>
            </div>
            <!-- /.box-body -->
          </div>
